...
[CCode (cprefix = "Ide", gir_namespace = "Ide", gir_version = "45", lower_case_cprefix = "ide_")]
namespace Ide {
	...
	public sealed class Buffer : GtkSource.Buffer {
		...
		public void get_selection_bounds (out unowned Gtk.TextIter? insert, out unowned Gtk.TextIter? selection);
	...
	public sealed class Context : Ide.Object {
		...
		public void log (GLib.LogLevelFlags level, string domain, string message);
		public unowned Ide.Object? peek_child_typed (GLib.Type type);
		public Ide.ActionMuxer ref_action_muxer ();
		[Version (since = "44")]
		public GLib.ListModel ref_logs ();
	...
	public sealed class ExtensionSetAdapter : Ide.Object, GLib.ListModel {
		[CCode (has_construct_function = false)]
		...
		public unowned Peas.Engine get_engine ();
		public unowned GLib.Object? get_extension (Peas.PluginInfo plugin_info);
		public GLib.Type get_interface_type ();
		public unowned string get_key ();
	...
	[CCode (cheader_filename = "libide-code.h,libide-core.h,libide-debugger.h,libide-editor.h,libide-foundry.h,libide-greeter.h,libide-gtk.h,libide-gui.h,libide-io.h,libide-lsp.h,libide-plugins.h,libide-projects.h,libide-search.h,libide-sourceview.h,libide-terminal.h,libide-threading.h,libide-tree.h,libide-tweaks.h,libide-vcs.h,libide-webkit.h", type_id = "ide_log_item_get_type ()")]
	public sealed class LogItem : GLib.Object {
		[CCode (has_construct_function = false)]
		protected LogItem ();
		[Version (since = "44")]
		public unowned GLib.DateTime get_created_at ();
		[Version (since = "44")]
		public unowned string get_domain ();
		[Version (since = "44")]
		public unowned string get_message ();
		[Version (since = "44")]
		public GLib.LogLevelFlags get_severity ();
		public GLib.DateTime created_at { get; construct; }
	...
	public sealed class RunContext : GLib.Object {
		...
		public void push_shell (Ide.RunContextShell shell);
		public void push_user_shell (Ide.RunContextShell shell);
	...
	[CCode (cheader_filename = "libide-code.h,libide-core.h,libide-debugger.h,libide-editor.h,libide-foundry.h,libide-greeter.h,libide-gtk.h,libide-gui.h,libide-io.h,libide-lsp.h,libide-plugins.h,libide-projects.h,libide-search.h,libide-sourceview.h,libide-terminal.h,libide-threading.h,libide-tree.h,libide-tweaks.h,libide-vcs.h,libide-webkit.h", type_id = "ide_runtime_provider_get_type ()")]
	public abstract class RuntimeProvider : Ide.Object, GLib.ListModel {
		[CCode (has_construct_function = false)]
		protected RuntimeProvider ();
		public void add (Ide.Runtime runtime);
		public virtual Dex.Future bootstrap_runtime (Ide.Pipeline pipeline);
		public virtual Dex.Future load ();
		public virtual bool provides (string runtime_id);
		public void remove (Ide.Runtime runtime);
		public virtual Dex.Future unload ();
	}
	...
	public sealed class Session : GLib.Object {
		...
		public Ide.SessionItem? lookup_by_id (string id);
	...
	public sealed class TerminalSearch : Gtk.Widget, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
		[CCode (has_construct_function = false)]
		...
		[NoAccessorMethod]
		public bool whole_words { get; set; }
		[NoAccessorMethod]
	...
	[CCode (cheader_filename = "libide-code.h,libide-core.h,libide-debugger.h,libide-editor.h,libide-foundry.h,libide-greeter.h,libide-gtk.h,libide-gui.h,libide-io.h,libide-lsp.h,libide-plugins.h,libide-projects.h,libide-search.h,libide-sourceview.h,libide-terminal.h,libide-threading.h,libide-tree.h,libide-tweaks.h,libide-vcs.h,libide-webkit.h", type_id = "ide_unique_list_model_get_type ()")]
	public sealed class UniqueListModel : GLib.Object, GLib.ListModel {
		[CCode (has_construct_function = false)]
		[Version (since = "44")]
		public UniqueListModel (owned GLib.ListModel? model, owned Gtk.Sorter? sorter);
		[Version (since = "44")]
	...
	public sealed class VcsCloneRequest : Ide.Object {
		...
		public async GLib.File clone_async (Ide.Notification notif, int pty_fd, GLib.Cancellable? cancellable) throws GLib.Error;
	...
	public interface BuildSystem : Ide.Object {
		...
		[Version (since = "44")]
		public virtual void prepare_tooling (Ide.RunContext run_context);
	...
	public interface TreeAddin : GLib.Object {
		...
		[Version (since = "44")]
		public abstract Gdk.DragAction node_droppable (Gtk.DropTarget drop_target, Ide.TreeNode drop_node, GLib.Array<GLib.Type?> gtypes);
	...
	public interface VcsCloner : Ide.Object {
		...
		[Version (since = "44")]
		public abstract void set_pty_fd (int pty_fd);
	...
	[CCode (cheader_filename = "libide-code.h,libide-core.h,libide-debugger.h,libide-editor.h,libide-foundry.h,libide-greeter.h,libide-gtk.h,libide-gui.h,libide-io.h,libide-lsp.h,libide-plugins.h,libide-projects.h,libide-search.h,libide-sourceview.h,libide-terminal.h,libide-threading.h,libide-tree.h,libide-tweaks.h,libide-vcs.h,libide-webkit.h", cprefix = "IDE_RUN_CONTEXT_SHELL_", type_id = "ide_run_context_shell_get_type ()")]
	public enum RunContextShell {
		DEFAULT,
		LOGIN,
		INTERACTIVE
	}
	...
	[CCode (cheader_filename = "libide-code.h,libide-core.h,libide-debugger.h,libide-editor.h,libide-foundry.h,libide-greeter.h,libide-gtk.h,libide-gui.h,libide-io.h,libide-lsp.h,libide-plugins.h,libide-projects.h,libide-search.h,libide-sourceview.h,libide-terminal.h,libide-threading.h,libide-tree.h,libide-tweaks.h,libide-vcs.h,libide-webkit.h", instance_pos = 3.9)]
	public delegate void ExtensionSetAdapterForeachFunc (Ide.ExtensionSetAdapter @set, Peas.PluginInfo plugin_info, GLib.Object extension);
	[CCode (cheader_filename = "libide-code.h,libide-core.h,libide-debugger.h,libide-editor.h,libide-foundry.h,libide-greeter.h,libide-gtk.h,libide-gui.h,libide-io.h,libide-lsp.h,libide-plugins.h,libide-projects.h,libide-search.h,libide-sourceview.h,libide-terminal.h,libide-threading.h,libide-tree.h,libide-tweaks.h,libide-vcs.h,libide-webkit.h", instance_pos = 2.9)]
