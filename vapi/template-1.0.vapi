/* template-1.0.vapi generated by vapigen, do not modify. */
...
namespace Tmpl {
	...
	public class Expr {
		...
		public bool eval (Tmpl.Scope scope, GLib.Value return_value) throws GLib.Error;
		[CCode (has_construct_function = false)]
		public Expr.flow (Tmpl.ExprType type, Tmpl.Expr condition, Tmpl.Expr primary, Tmpl.Expr secondary);
		[CCode (has_construct_function = false)]
		public Expr.fn_call (Tmpl.ExprBuiltin builtin, Tmpl.Expr param);
		public static Tmpl.Expr from_string (global::string str) throws GLib.Error;
		[CCode (has_construct_function = false)]
		public Expr.func (global::string name, global::string symlist, Tmpl.Expr list);
		public Tmpl.Expr new_anon_call (Tmpl.Expr @params);
		public Tmpl.Expr new_getattr (global::string attr);
		public Tmpl.Expr new_gi_call (global::string name, Tmpl.Expr @params);
		public Tmpl.Expr new_invert_boolean ();
		public Tmpl.Expr new_setattr (global::string attr, Tmpl.Expr right);
		[CCode (has_construct_function = false)]
		public Expr.nop ();
		[CCode (has_construct_function = false)]
		public Expr.@null ();
		...
		public Tmpl.Expr @ref ();
		[CCode (has_construct_function = false)]
		public Expr.require (global::string typelib, global::string version);
		[CCode (has_construct_function = false)]
		public Expr.simple (Tmpl.ExprType type, Tmpl.Expr left, Tmpl.Expr right);
		[CCode (has_construct_function = false)]
		[Version (since = "3.36")]
		public Expr.stmt_list (owned GLib.GenericArray<Tmpl.Expr> stmts);
		[CCode (has_construct_function = false)]
		public Expr.string (global::string value, ssize_t length);
		[CCode (has_construct_function = false)]
		public Expr.symbol_assign (global::string symbol, Tmpl.Expr right);
		[CCode (has_construct_function = false)]
		public Expr.symbol_ref (global::string symbol);
		public void unref ();
		[CCode (has_construct_function = false)]
		public Expr.user_fn_call (global::string name, Tmpl.Expr param);
	}
	...
	public class Scope {
		[CCode (has_construct_function = false)]
		public Scope ();
		public unowned Tmpl.Symbol @get (string name);
		[CCode (array_length = false, array_null_terminated = true)]
		public string[] list_symbols (bool recursive);
		public Tmpl.Scope new_with_parent ();
		public unowned Tmpl.Symbol? peek (string name);
		public Tmpl.Scope @ref ();
		public bool require (string namespace_, string? version);
		public void @set (string name, Tmpl.Symbol? symbol);
		...
		public void set_resolver (owned Tmpl.ScopeResolver resolver);
		...
		public void take (string name, owned Tmpl.Symbol? symbol);
		public void unref ();
	}
	...
	public class Symbol {
		...
		public unowned Tmpl.Expr get_expr (out unowned GLib.GenericArray<string>? @params);
		public Tmpl.SymbolType get_symbol_type ();
		public void get_value (GLib.Value value);
		public bool holds (GLib.Type type);
		public Tmpl.Symbol @ref ();
		public void unref ();
	}
	[CCode (cheader_filename = "tmpl-glib.h", type_id = "tmpl_template_get_type ()")]
	public class Template : GLib.Object {
		[CCode (has_construct_function = false)]
		public Template (Tmpl.TemplateLocator? locator);
		public bool expand (GLib.OutputStream stream, Tmpl.Scope? scope, GLib.Cancellable? cancellable = null) throws GLib.Error;
		public string expand_string (Tmpl.Scope? scope) throws GLib.Error;
		...
		public Tmpl.TemplateLocator locator { get; set construct; }
	}
	...
	public delegate bool ScopeResolver (Tmpl.Scope scope, string name, Tmpl.Symbol symbol);
	...
	public static Tmpl.Expr expr_from_string (string str) throws GLib.Error;
}
