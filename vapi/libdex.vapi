/* libdex.vapi generated by vapigen, do not modify. */
...
namespace Dex {
	...
	public class Future : Dex.Object {
		[CCode (has_construct_function = false)]
		protected Future ();
		public static Dex.Future all_racev ([CCode (array_length_cname = "n_futures", array_length_pos = 1.1, array_length_type = "guint")] Dex.Future[] futures);
		public static Dex.Future allv ([CCode (array_length_cname = "n_futures", array_length_pos = 1.1, array_length_type = "guint")] Dex.Future[] futures);
		public static Dex.Future anyv ([CCode (array_length_cname = "n_futures", array_length_pos = 1.1, array_length_type = "guint")] Dex.Future[] futures);
		public static Dex.Future firstv ([CCode (array_length_cname = "n_futures", array_length_pos = 1.1, array_length_type = "guint")] Dex.Future[] futures);
		[CCode (has_construct_function = false)]
	...
	[CCode (cheader_filename = "libdex.h", has_target = false)]
	public delegate void SchedulerFunc (void* func_data);
